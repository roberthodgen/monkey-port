(function() {
	...
	var app = angular.module('mp.poll', []);

	app.directive('createPoll', function(Poll) {
		return {
			restrict: 'AE',
			templateUrl: '/partials/create-poll-directive.html',
	...
	app.directive('pollDetail', function(Poll) {
		return {
			restrict: 'AE',
			templateUrl: '/partials/poll-detail-directive.html'
		};
	});
	...
	app.directive('pollPreview', function(Poll) {
		return {
			restrict: 'AE',
			templateUrl: '/partials/poll-preview-directive.html'
		};
	});
